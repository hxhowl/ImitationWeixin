...
@interface RecvTVCell : UITableViewCell
...
#pragma mark 信息label
@property (weak, nonatomic) IBOutlet UILabel *recvMsgShowLabel;
#pragma mark 承载label的view与，整个信息view的底部约束
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *recvMsgShowLabelViewBottom;
#pragma mark 承载label的view
@property (weak, nonatomic) IBOutlet UIView *recvMsgShowLabelView;
#pragma mark 承载label的view上的imageview，用来显示背景图片
@property (weak, nonatomic) IBOutlet UIImageView *recvMsgImageView;
